...
from .serializers import StudentSerializer,StudentCreateSerializer, StudentRetrieveSerializer
...
#     def get(self, request, *args, **kwargs): #GET retrieveing list of students
#         students= Student.objects.all()
#         serializer= StudentRetrieveSerializer(students, many=True)
#         return response.Response(serializer.data, status= status.HTTP_200_OK)

#     def post(self, request, *args, **kwargs): #POST creatiing new student
